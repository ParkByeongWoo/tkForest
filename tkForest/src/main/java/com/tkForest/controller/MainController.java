...
//    }
	...
	public String index(
	    ...
	    Page<ProductDTO> listByRegistrationDate = productService.selectAll(pageable, searchType, query, "registrationDate");

	    // viewCount 기준으로 정렬된 리스트
	    Page<ProductDTO> listByViewCnt = productService.selectAll(pageable, searchType, query, "viewCnt");
